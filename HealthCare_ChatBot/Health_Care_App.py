...
class ChatApplication:
    ...
    def _get_name(self):
        ...
        # entry label
        self.name = Label(self.window, bg=clr, fg=TEXT_COLOR,
                           text="Please Enter Your name", font=("Times", "12", "bold italic"), pady=10)
        ...
        #msg entery box
        self.name_entry = Entry(name_label, bg=BG_GRAY, fg="BLACK", font=("Times", "12", "bold italic"))
        ...
        #button
        name_send_button = Button(name_box_label, text="Submit", fg=TEXT_COLOR, font=("Times", "12", "bold italic"), width=20, bg=clr,
        ...
        about.add_command(label="Develpoers", command=lambda: self.msg_showinfo(f"Bot Develpoers ",f"Project Mentor - Miss Rohini patil \n\nGroup number - 01 \n\nGroup Members \n\n1. Rohini patil (105501) \n2. Dimpla (185506) \n3. swati mali (185532) \n"),font="bold")
    ...
    def _setup_main_window(self):
        ...
        self.name = Label(leftside_label, bg=BG_COLOR, fg=TEXT_COLOR,
                           text=self.name_entry.get().capitalize(), font=("Times", "12", "bold italic"), pady=10)
        self.name.place(relheight=0.07, relwidth=1,y=1)

        # sidebox Help box
        self.help = Label(leftside_label, bg=clr, fg=TEXT_COLOR,
                           text="Help Search (Similar diseases)", font=("Times", "12", "bold italic") , pady=10)
        ...
        self.help_entry = Entry(search_label, bg=BG_GRAY, fg="BLACK", font=("Times", "12", "bold italic"))
        ...
        # send button
        help_send_button = Button(search_label, text="Search", font=("Times", "12", "bold italic"), width=20, bg=BG_GRAY,
        ...
        scrollsearch.configure(command=self.search_box.yview,background='#d9b1f2')
        ...
        # text widget
        self.text_widget = Text(rightside_label, width=20, height=2, bg='#000', fg=TEXT_COLOR,
        ...
        # send button
        send_button = Button(bottom_label, text="Send", font=("Times", "12", "bold italic"), width=20, bg=BG_GRAY,
